...
------------------------
There are two ways to run the demo. First you can use ``canopen_fake_slave`` to simulate the robot using CAN interface ``can0``. Second you can use the real robot.
